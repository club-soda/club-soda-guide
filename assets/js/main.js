...
var author$project$DrinksCarousel$Model = function (drinks) {
	return {drinks: drinks};
};
var author$project$DrinksCarousel$ReceiveDrinks = function (a) {
	return {$: 'ReceiveDrinks', a: a};
};
var author$project$DrinksCarousel$Drink = F3(
	function (name, brand, abv) {
		return {abv: abv, brand: brand, name: name};
	});
...
var author$project$DrinksCarousel$drinkDecoder = A4(
	elm$json$Json$Decode$map3,
	author$project$DrinksCarousel$Drink,
	A2(elm$json$Json$Decode$field, 'name', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'brand', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'abv', elm$json$Json$Decode$float));
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$DrinksCarousel$drinksDecoder = elm$json$Json$Decode$list(author$project$DrinksCarousel$drinkDecoder);
...
var author$project$DrinksCarousel$getDrinks = A2(
	elm$http$Http$send,
	author$project$DrinksCarousel$ReceiveDrinks,
	A2(elm$http$Http$get, '/json_drinks', author$project$DrinksCarousel$drinksDecoder));
var author$project$DrinksCarousel$init = function (_n0) {
	return _Utils_Tuple2(
		author$project$DrinksCarousel$Model(_List_Nil),
		author$project$DrinksCarousel$getDrinks);
};
var elm$core$Platform$Sub$batch = _Platform_batch;
var elm$core$Platform$Sub$none = elm$core$Platform$Sub$batch(_List_Nil);
var author$project$DrinksCarousel$subscriptions = function (model) {
	return elm$core$Platform$Sub$none;
};
var elm$core$Debug$log = _Debug_log;
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$DrinksCarousel$update = F2(
	function (msg, model) {
		if (msg.a.$ === 'Err') {
			var a = A2(elm$core$Debug$log, 'drinks ok', 'no');
			return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
		} else {
			var drinks = msg.a.a;
			var a = A2(elm$core$Debug$log, 'drinks ok', 'yes');
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{drinks: drinks}),
...
var author$project$DrinksCarousel$main = elm$browser$Browser$element(
	{init: author$project$DrinksCarousel$init, subscriptions: author$project$DrinksCarousel$subscriptions, update: author$project$DrinksCarousel$update, view: author$project$DrinksCarousel$view});
_Platform_export({'DrinksCarousel':{'init':author$project$DrinksCarousel$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"DrinksCarousel.Msg","aliases":{"DrinksCarousel.Drink":{"args":[],"type":"{ name : String.String, brand : String.String, abv : Basics.Float }"},"DrinksCarousel.HttpData":{"args":["data"],"type":"Result.Result Http.Error data"},"Http.Response":{"args":["body"],"type":"{ url : String.String, status : { code : Basics.Int, message : String.String }, headers : Dict.Dict String.String String.String, body : body }"}},"unions":{"DrinksCarousel.Msg":{"args":[],"tags":{"ReceiveDrinks":["DrinksCarousel.HttpData (List.List DrinksCarousel.Drink)"]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Http.Response String.String"],"BadPayload":["String.String","Http.Response String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":[]}},"Dict.NColor":{"args":[],"tags":{"Red":[],"Black":[]}}}}})}});}(this));